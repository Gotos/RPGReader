...
public class LuciferEventCommand implements UnitInterface {
	...
	public static final int CHANGE_VARIABLE					= 10220; //Wenn ein Event als Datenherkunft gew�hlt wird, wird als 6ter Parameter die Event-ID �bergeben. Hero folgt bei 10001.
	...
	private void init(DataReader sr) throws IOException {
		...
		for (int i = 0; i < length; i++) {
			data[i] = sr.nextInt(); // hier *muss* nextInt verwendet werden, da length angibt, wie viele argumente folgen, nicht deren gesamtlänge.
		}
	}
